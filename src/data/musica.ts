...
export const artists: Artist[] = [
  ...
  { name: "Diomedes Díaz", genre: "Vallenato", note: "El Cacique de La Junta. The most beloved voice in vallenato history, still on every parranda." },
  ...
  { name: "Morat", genre: "Pop-folk", note: "Bogotá's pop-folk juggernaut. Four guys, acoustic strings, arenas full of singalongs." },
